	...
	?>
        ...
        <div id="page-wrapper">
            <div class="row">
				...
				<div class="col-md-4 col-sm-6 col-xs-6 popover-icon" data-container="body" data-toggle="popover" data-placement="bottom"
				data-content="
				<p><strong>Description:</strong> This app is used to teach clothing English words by pictures and sounds. It can be install on SD 
				card for Android 2.2. <ol>
				<li>You can have your favorite pictures.</li>
				<li>You can test words by choosing pictures.</li>
				<li>It can support speak test.</li></ol></p>
				...
				<div class="col-md-4 col-sm-6 col-xs-6 popover-icon" data-container="body" data-toggle="popover" data-placement="bottom"
				data-content="
				<p><strong>Description:</strong> A token board that's handy wherever an opportunity to teach a desirable behavior arises!
				A common teaching tool for behavior development and modification, including ABA. Great for young children as well as kids on the autistic 
				spectrum, asperger's, PDD NOS, Down syndrome or other kinds of developmental delay.
				...
				<p><i>Options to change Font Size and Style, Line Spacing, Margins, Justification, Brightness and Background Colour ...following 
				'some principles from the British Dyslexia Association's 
				<a href='http://www.bdadyslexia.org.uk/about-dyslexia/further-information/dyslexia-style-guide.html' target='_blank'>Style Guide</a>
				...
				<div class="col-md-4 col-sm-6 col-xs-6 popover-icon" data-container="body" data-toggle="popover" data-placement="bottom"
				data-content="
				<p><strong>Description:</strong> K-9 Mail is an open-source e-mail client with search, IMAP push email, multi-folder sync, flagging, 
				...
				<div class="col-md-4 col-sm-6 col-xs-6 popover-icon" data-container="body" data-toggle="popover" data-placement="bottom" 
				data-content="
				<p><strong>Description:</strong> Cause and Effect Sensory Light Box was originally created for a group of teenagers with complex needs 
				including visual impairment, autism and developmental disabilities. Light Box has since proven popular with parents and teachers of 
				much younger children with and without special needs.
				...
				<div class="col-md-4 col-sm-6 col-xs-6 popover-icon" data-container="body" data-toggle="popover" data-placement="bottom" 
				data-content="
				<p><strong>Description:</strong> PhotoVOCA is a free switch accessible communication board maker for Android tablets ... It supports 
				both text-to-speech and digital voice recording. PhotoVOCA provides the simplest possible AAC tool for new, young and less able communicators
				...
				<div class="col-md-4 col-sm-6 col-xs-6 popover-icon" data-container="body" data-toggle="popover" data-placement="bottom"
				data-content="
				<p><strong>Description:</strong> PicAlarms is an alarm clock that displays a chosen picture when it goes off. In addition to the typical 
				alarm settings it allows you to select a picture from the device's gallery and add it to the alarm. This app is designed to help people
				with reading disabilities. It is a free app with no ads and fully supported by Appestry. </p>
				...
				<div class="col-md-4 col-sm-6 col-xs-6 popover-icon" data-container="body" data-toggle="popover" data-placement="bottom"
				data-content="
				<p><strong>Description:</strong> Image to Text to Speech. <i>While not available on the Google Play Store directly, I have been very impressed with this app. 
				...
				<p><strong>Description:</strong> TalkBack is an Accessibility Service that helps blind and vision-impaired users interact with 
				their devices more easily. This application add spoken, audible, and vibration feedback to your device. <strong>It is a system application 
				...
				<div class="col-md-4 col-sm-6 col-xs-6 popover-icon" data-container="body" data-toggle="popover" data-placement="bottom"
				data-content="
				<p><strong>Description:</strong> The VizZle Student Player (TM) is a kid-friendly environment that allows educators and parents to launch 
				interactive instructional lessons for children who learn best from visually supported materials (e.g. children with autism, in early 
				education, or typical children with a visual learning style). VizZle Student Player was designed using exclusively licensed intellectual 
				property stemming from research proving the efficacy of a visual language-based approach to educating students with autism. It is also 
				equally effective for any student who learns best visually. </p>
				<p><i>I read elsewhere that Vizzle Editor costs around ...' $25 per month for families and $100 per month for clinicians. School districts 
