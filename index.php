...
<body>
	...
	?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-xs-12">
                    <h3 class="page-header">Welcome to this Support Site for the Android in Schools Project (ASP)</h3>
					<hr>
					...
					<img class="col-xs-8 col-xs-offset-2 col-sm-offset-0 col-sm-3 col-md-3" src="images/Android_robot.png">
